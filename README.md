<div align="center">
  ...
  <p align="center">Idle games or unlock achievements in your Steam library effortlessly. Simply provide your Steam profile name or ID64. No password, token, or other login information is needed.</p>
<p align="center">
...
* **[CLI + Web UI](https://github.com/probablyraging/steam-game-idler/tree/cli-webui)**: windows, linux, and macos supported version with a command-line interface and/or web interface *(requires login information)*
...
3. **Build idler**: `msbuild ./idler-csharp/idler.csproj`
	* Outputs to `/libs` dir in `/src-tauri`
